...
const products = [
    {id: 1, name: "Shakers", price: 12000, category: "TOYS", image: "images/toy.jpg"},
    {id: 2, name: "Bath-combo", price: 200000, category: "BATH", image: "images/babycare.jpg"},
    {id: 3, name: "Baby seat", price: 500000, category: "FASHION", image: "images/seat.jpg"},
    {id: 4, name: "Cutlery", price: 30000, category: "FEEDING", image: "images/cutlery.jpg"},
    {id: 5, name: "Feeding Bottle", price: 50000, category: "FEEDING", image: "images/bottle.jpg"},
    {id: 6, name: "Shoes", price: 50000, category: "FASHION", image: "images/shoes.jpg"} 
    
    // Reuse babyseat img for demo
];
...
function addToCart(id) {
    ...
    try {
        ...
        if (cartItem) {
            ...
            cart.push({...product, qty: 1});//spread operator ... for splitting an array
        }
...
function displayCart() {
    ...
    cart.forEach((item, index) => {
        ...
        div.innerHTML = `
            ...
            <span>${item.name} - UGX ${item.price.toLocaleString()} x </span>
            <div class="quantity">
            ...
            <p>Subtotal: UGX ${(item.price * item.qty).toLocaleString()}</p>
        `;
        cartItems.appendChild(div);
        total += item.price * item.qty;
    });

    totalEl.textContent = `Total: UGX ${total.toLocaleString()}`;
}
...
function validateCheckout() {
    try {
        ...
        // Email validation
        const emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/; // VALIDATOR FOR EMAIL
